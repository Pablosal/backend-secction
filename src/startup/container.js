...
const {CommentService,IdeaService,UserService,HomeService,AuthService} = require("../services")
const app = require(".");
container
  .register({
  ...
  .register({
    ...
    AuthController: asClass(IdeaController.bind(AuthController)).singleton(),
  })
  .register({
